...
//    NSString *devicePort = [AppDelegate searchForDevice:@"MindWaveMobile"];
    ...
    self.imageView.image = [NSImage imageNamed:@"1"];
...
-(void) onDataReceived:(NSInteger)datatype data:(int)data obj:(NSObject *)obj {
    ...
    //NSLog(@"Datetype: %d, Raw data: %d", datatype, data);
    switch(datatype)
    {
            case 0xBA:
            case 0xBC:
...
//            self.imageView.inputContext;
            ...
            case MindDataType_CODE_RAW:
                ...
                if(data > 50){
                    ...
                    self.imageView.image = [NSImage imageNamed:@"4"];
                }else{
                    self.imageView.image = [NSImage imageNamed:@"7"];
                }
                break;
            ...
            case MindDataType_CODE_MEDITATION:
                str_type = @"MindDataType_CODE_MEDITATION"; break;
